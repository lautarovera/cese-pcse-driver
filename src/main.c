...
static void STM_GPIO_Init(void);
static void STM_ETH_Init(void);
static void STM_USART3_UART_Init(void);
static void STM_USB_OTG_FS_PCD_Init(void);
/* USER CODE BEGIN PFP */
...
int main(void)
{
  ...
  STM_GPIO_Init();
  STM_ETH_Init();
  STM_USART3_UART_Init();
  STM_USB_OTG_FS_PCD_Init();

  /* USER CODE BEGIN 2 */
  lis2dw12_usr_cfg.odr = LIS2DW12_ODR_200_HZ;
  lis2dw12_usr_cfg.mode = LIS2DW12_MODE_HI_PF;
  lis2dw12_usr_cfg.lpmode = LIS2DW12_LP_MODE_UNDEF;
